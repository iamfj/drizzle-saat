...
- f26390b: Initial release: type-safe, deterministic database seeding for Drizzle ORM.
  ...
  - Codegen of global namespace types (`.drizzle-saat/types.d.ts`), regenerated before each run.
  ...
  - CLI: `drizzle-saat`, `drizzle-saat generate`, `--scenario`, `--seed`, `--dry-run`, `--watch`.
